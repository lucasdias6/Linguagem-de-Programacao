...
# Crie um segundo arquivo chamado main.py na mesma pasta. Importe a função validar_usuario. No programa principal, use um input para perguntar o nome do usuário, passe esse nome para a função importada e exiba a resposta na tela.

from seguranca import validar_login
